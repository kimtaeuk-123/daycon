...
X_test = X_test.reshape(7776,6) # (162,48,6) 하니까 안되고 (7776,6)하니까 됨.. Dense 모델은 그럼 predict 는 2차원이어야 되는건가??
...
print(x_test.shape) # (10493, 288)
print(y_train.shape) # (41972, 96)
print(y_test.shape) # (10493, 96)
print(X_test.shape) # (162,288)
x_train = x_train.reshape(41972,48,6)
x_test = x_test.reshape(10493,48,6)
# y_train = y_train.reshape(41972,48,2)
# y_test = y_test.reshape(10493,48,2)
...
for q in quantiles:
    ...
    model.fit(x_train, y_train, batch_size=10, epochs=5, validation_split=0.4, callbacks=[reduce])
